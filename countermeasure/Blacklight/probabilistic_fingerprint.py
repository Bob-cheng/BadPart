...
import imp
np.random.seed(666)
gen_util = imp.load_source('gen_util', 'countermeasure/Blacklight/utils.py')
...
class InputTracker:
    def __init__(self, shape, window_size, num_hashes_keep, round=50, step_size=1, workers=5, salt=None):
        ...
        if(salt != None):
            ...
            self.salt = np.random.rand(*shape) * 255.
