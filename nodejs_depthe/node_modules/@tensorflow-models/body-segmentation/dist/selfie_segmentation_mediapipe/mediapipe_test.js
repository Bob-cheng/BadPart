...
(0, jasmine_util_1.describeWithFlags)('MediaPipe SelfieSegmentation static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var segmenter;
    var image;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, test_util_1.loadImage)('portrait.jpg', 820, 1024)];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, (0, test_util_1.loadImage)('portrait_segmentation.png', 820, 1024)];
                case 2:
                    segmentationImage =
                        _a.sent();
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, bodySegmentation.createSegmenter(model, __assign(__assign({}, MEDIAPIPE_MODEL_CONFIG), { modelType: 'general' }))];
                case 1:
                    segmenter = _a.sent();
    ...
    it('landscape model test.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    model = bodySegmentation.SupportedModels.MediaPipeSelfieSegmentation;
                    return [4 /*yield*/, bodySegmentation.createSegmenter(model, __assign(__assign({}, MEDIAPIPE_MODEL_CONFIG), { modelType: 'landscape' }))];
                case 1:
                    segmenter = _a.sent();
                    expectSegmenter(segmenter, image, segmentationImage);
                    segmenter.dispose();
