...
export declare type MediaPipeSelfieSegmentationModelType = 'general' | 'landscape';
/**
...
export interface MediaPipeSelfieSegmentationSegmentationConfig extends SegmentationConfig {
}
/**
 ...
 */
export interface MediaPipeSelfieSegmentationMediaPipeModelConfig extends MediaPipeSelfieSegmentationModelConfig {
    runtime: 'mediapipe';
    solutionPath?: string;
 ...
 */
export interface MediaPipeSelfieSegmentationMediaPipeSegmentationConfig extends MediaPipeSelfieSegmentationSegmentationConfig {
}
