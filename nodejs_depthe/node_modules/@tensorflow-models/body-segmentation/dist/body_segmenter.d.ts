...
export interface BodySegmenter {
     ...
     */
    segmentPeople(input: BodySegmenterInput, segmentationConfig?: MediaPipeSelfieSegmentationMediaPipeSegmentationConfig | MediaPipeSelfieSegmentationTfjsSegmentationConfig | BodyPixSegmentationConfig): Promise<Segmentation[]>;
    /**
